...
(function () {
    ...
    function showSettingsPopup() {
        ...
        ensureTranslationsLoaded(false).catch(function () {
            ...
            title.textContent = t('menu.title', 'i1Kosar & CONNOR · Menu');
            ...
            const removeBtn = createMenuButton('lt-settings-remove-lua', 'menu.removeLuaTools', 'Remove via i1Kosar & CONNOR', 'fa-trash-can');
                    ...
                    try {
                        Millennium.callServerMethod('luatools', 'CheckForUpdatesNow', {
                            ...
                            try {
                                ...
                                ShowLuaToolsAlert('i1Kosar & CONNOR', msg);
                            } catch (_) { }
                        });
                    } catch (_) { }
                });
            ...
            if (discordBtn) {
                discordBtn.addEventListener('click', function (e) {
                    ...
                    const url = 'https://discord.gg/fUGkFCRMGk';
                    try {
                    ...
                    try {
                        Millennium.callServerMethod('luatools', 'FetchFreeApisNow', {
                            ...
                            try {
                                ...
                                ShowLuaToolsAlert('i1Kosar & CONNOR', text);
                            } catch (_) { }
                        });
                    } catch (_) { }
                });
                ...
                fixesMenuBtn.addEventListener('click', function (e) {
                    ...
                    try {
                        ...
                        if (isNaN(appid)) {
                            ...
                            ShowLuaToolsAlert('i1Kosar & CONNOR', errText);
                            return;
                        }
                        ...
                        Millennium.callServerMethod('luatools', 'GetGameInstallPath', {
                            ...
                            ShowLuaToolsAlert('i1Kosar & CONNOR', errorText);
                        });
                    } catch (err) {
                        ...
                        try {
                            ...
                            if (exists) {
                                    ...
                                    try {
                                        Millennium.callServerMethod('luatools', 'DeleteLuaToolsForApp', {
                                            ...
                                            try {
                                                ...
                                                addLuaToolsButton();
                                                const successText = t('menu.remove.success', 'i1Kosar & CONNOR removed for this app.');
                                                ShowLuaToolsAlert('i1Kosar & CONNOR', successText);
                                            } catch (err) {
                                            ...
                                            ShowLuaToolsAlert('i1Kosar & CONNOR', errMsg);
                                        });
                                    } catch (err) {
                                ...
                                removeBtn.onclick = function (e) {
                                    ...
                                    const confirmMessage = t('menu.remove.confirm', 'Remove via i1Kosar & CONNOR for this game?');
                                    showLuaToolsConfirm('i1Kosar & CONNOR', confirmMessage, function () {
                                        doDelete();
                                    }, function () {
                                        try {
                                            showSettingsPopup();
    ...
    function showTestPopup() {
        ...
        title.textContent = t('common.appName', 'i1Kosar & CONNOR');
    ...
    function showFixesResultsPopup(data, isGameInstalled) {
        ...
        const title = document.createElement('div');
        title.style.cssText = `font-size:24px;color:${colors.text};font-weight:700;text-shadow:0 2px 8px ${colors.shadow};background:${colors.gradientLight};-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;`;
        title.textContent = lt('i1Kosar & CONNOR · Fixes Menu');
        ...
        const unfixSection = createFixButton(
            ...
            function (e) {
                ...
                if (isGameInstalled) {
                    ...
                    showLuaToolsConfirm('i1Kosar & CONNOR', lt('Are you sure you want to un-fix? This will remove fix files and verify game files.'),
                        function () {
            ...
            try {
                Millennium.callServerMethod('luatools', 'UnFixGame', {
                    ...
                    if (payload && payload.success) {
                        ...
                        ShowLuaToolsAlert('i1Kosar & CONNOR', errorMsg);
                    }
                }).catch(function () {
        ...
        try {
            ...
            Millennium.callServerMethod('luatools', 'ApplyGameFix', {
                ...
                try {
                    const payload = typeof res === 'string' ? JSON.parse(res) : res;
                    if (payload && payload.success) {
                        // Show download progress popup similar to Add via i1Kosar & CONNOR
    ...
    function showFixDownloadProgress(appid, fixType) {
        // Reuse the download popup UI from Add via i1Kosar & CONNOR
        if (document.querySelector('.luatools-overlay')) return;
    ...
    function fetchSettingsConfig(forceRefresh) {
        ...
        if (typeof Millennium === 'undefined' || typeof Millennium.callServerMethod !== 'function') {
            return Promise.reject(new Error(lt('i1Kosar & CONNOR backend unavailable')));
        }
    ...
    function showSettingsManagerPopup(forceRefresh, onBack) {
        ...
        function createLuaListItem(script, container) {
            ...
            deleteBtn.addEventListener('click', function (e) {
                ...
                showLuaToolsConfirm(
                    script.gameName || 'i1Kosar & CONNOR',
                    t('settings.installedLua.deleteConfirm', 'Remove via i1Kosar & CONNOR for this game?'),
                    function () {
                        // User confirmed
                        deleteBtn.dataset.busy = '1';
                        deleteBtn.style.opacity = '0.6';
    ...
    function showLuaToolsAlert(title, message, onClose) {
        ...
        titleEl.textContent = String(title || 'i1Kosar & CONNOR');
    ...
    function showMillenniumDisclaimerModal() {
        ...
        line1.textContent = t('disclaimer.line1', 'i1Kosar & CONNOR is not affiliated in any way with Millennium');
        ...
        line3.textContent = t('disclaimer.line3', 'You will be BANNED from both i1Kosar & CONNOR and Millennium servers if you go to their discord asking for help');
    ...
    function updateButtonTranslations() {
        try {
            ...
            // Update Add via i1Kosar & CONNOR button
            const luatoolsBtn = document.querySelector('.luatools-button');
            if (luatoolsBtn) {
                const addViaText = lt('Add via i1Kosar & CONNOR');
    ...
    function addLuaToolsButton() {
        ...
        if (!isAppPath) {
            ...
            if (headerContainer && !document.querySelector('.luatools-header-button') && !window.__LuaToolsHeaderInserted) {
                ...
                headerBtn.title = 'i1Kosar & CONNOR Settings';

                headerBtn.setAttribute('data-tooltip-text', 'i1Kosar & CONNOR Settings');
                ...
                if (!document.querySelector('.luatools-restart-button') && !window.__LuaToolsRestartInserted) {
                    ...
                    restartBtn.addEventListener('click', function (e) {
                        ...
                        try {
                            ...
                            closeSettingsOverlay();
                            showLuaToolsConfirm('i1Kosar & CONNOR', lt('Restart Steam now?'),
                                function () {
                                    try {
                    ...
                    try {
                        if (!document.querySelector('.luatools-icon-button') && !window.__LuaToolsIconInserted) {
                            ...
                            iconBtn.href = '#';
                            iconBtn.title = 'i1Kosar & CONNOR Helper';
                            iconBtn.setAttribute('data-tooltip-text', 'i1Kosar & CONNOR Helper');
                                ...
                                fetchFixes(appid).then(function (fixesData) {
                                    ...
                                    if (btn) {
                                        ...
                                        if (span && span.textContent === 'Unplayable') {
                                            span.textContent = lt('Add via i1Kosar & CONNOR');
                                        }
                                    }
                    ...
                    try {
                        ...
                        if (payload && payload.message) {
                            ...
                            if (isUpdateMsg) {
                                ...
                                showLuaToolsConfirm('i1Kosar & CONNOR', msg, function () {
    ...
    // ============================================
    // ACCESS KEY GATE  (server-validated, one-time-use)
    // ============================================

    // ▼▼▼ REPLACE THIS with your Railway server URL after deploying ▼▼▼
    const LUATOOLS_KEY_SERVER = 'https://keyserver-production-9134.up.railway.app';
    // ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲

    const LUATOOLS_ACCESS_KEY_STORAGE = 'luatools_access_key_verified';
    const LUATOOLS_MACHINE_ID_STORAGE = 'luatools_machine_id';

    // Generate or retrieve a stable machine ID for this browser/profile
    function getLuaToolsMachineId() {
        try {
            let id = localStorage.getItem(LUATOOLS_MACHINE_ID_STORAGE);
            if (!id) {
                id = 'M-' + Math.random().toString(36).slice(2) + Date.now().toString(36);
                localStorage.setItem(LUATOOLS_MACHINE_ID_STORAGE, id);
            }
            return id;
        } catch (_) { return 'unknown'; }
    }

    function showAccessKeyModal(onSuccess) {
        if (document.querySelector('.luatools-accesskey-overlay')) return;
        ensureLuaToolsStyles();
        const overlay = document.createElement('div');
        overlay.className = 'luatools-accesskey-overlay luatools-alert-overlay';
        overlay.style.cssText = 'position:fixed;inset:0;background:rgba(0,0,0,0.80);backdrop-filter:blur(8px);z-index:100000;display:flex;align-items:center;justify-content:center;';

        const c = getThemeColors();
        const modal = document.createElement('div');
        modal.style.cssText = `background:${c.modalBg};color:${c.text};border:2px solid ${c.border};border-radius:8px;width:420px;padding:32px;box-shadow:0 20px 60px rgba(0,0,0,.85);`;

        const title = document.createElement('div');
        title.style.cssText = `font-size:20px;font-weight:700;margin-bottom:8px;background:${c.gradientLight};-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;`;
        title.textContent = 'i1Kosar & CONNOR · Access Key';

        const subtitle = document.createElement('div');
        subtitle.style.cssText = 'font-size:13px;color:#8f98a0;margin-bottom:20px;';
        subtitle.textContent = 'Enter your access key to activate this feature. Each key can only be used on one PC.';

        const input = document.createElement('input');
        input.type = 'text';
        input.placeholder = 'Enter access key…';
        input.style.cssText = `width:100%;box-sizing:border-box;padding:10px 14px;border-radius:4px;border:1px solid ${c.border};background:rgba(255,255,255,0.05);color:${c.text};font-size:14px;margin-bottom:8px;outline:none;font-family:monospace;letter-spacing:1px;`;

        const errorMsg = document.createElement('div');
        errorMsg.style.cssText = 'color:#ff6b6b;font-size:12px;min-height:18px;margin-bottom:14px;';
        ...
        cancelBtn.style.cssText = 'padding:8px 18px;border-radius:4px;border:1px solid #555;background:transparent;color:#aaa;cursor:pointer;font-size:13px;';
        cancelBtn.onclick = function () { overlay.remove(); };

        const confirmBtn = document.createElement('button');
        confirmBtn.textContent = 'Activate';
        confirmBtn.style.cssText = `padding:8px 22px;border-radius:4px;border:none;background:${c.accent};color:#fff;cursor:pointer;font-size:13px;font-weight:600;`;

        confirmBtn.onclick = function () {
            const val = input.value.trim();
            if (!val) { errorMsg.textContent = 'Please enter a key.'; return; }

            confirmBtn.disabled = true;
            confirmBtn.textContent = 'Checking…';
            errorMsg.textContent = '';

            const machineId = getLuaToolsMachineId();

            fetch(LUATOOLS_KEY_SERVER + '/validate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ key: val, machineId: machineId })
            })
            .then(function (r) { return r.json(); })
            .then(function (data) {
                if (data.ok) {
                    try { localStorage.setItem(LUATOOLS_ACCESS_KEY_STORAGE, '1'); } catch (_) {}
                    try { localStorage.setItem(LUATOOLS_ACCESS_KEY_STORAGE + '_key', val); } catch (_) {}
                    overlay.remove();
                    onSuccess();
                } else {
                    errorMsg.textContent = data.error || 'Invalid key. Please try again.';
                    input.value = '';
                    input.focus();
            ...
            .catch(function () {
                errorMsg.textContent = 'Could not reach the key server. Check your connection.';
                confirmBtn.disabled = false;
                confirmBtn.textContent = 'Activate';
            });
        };
        ...
        if (window.GamepadNav) { setTimeout(function () { window.GamepadNav.scanElements(); }, 150); }
    }

    function runAddFlowWithKeyGate(continueWithAdd) {
        const machineId = getLuaToolsMachineId();
        const storedKey = (function() { try { return localStorage.getItem(LUATOOLS_ACCESS_KEY_STORAGE + '_key'); } catch(_) { return null; } })();

        if (storedKey) {
            // Silently re-verify with server on every click
            fetch(LUATOOLS_KEY_SERVER + '/validate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ key: storedKey, machineId: machineId, silent: true })
            })
            .then(function(r) { return r.json(); })
            .then(function(data) {
                if (data.ok) {
                    // Still valid — proceed invisibly
                    continueWithAdd();
                } else {
                    // Key was revoked or invalid — clear local storage and show prompt
                    try { localStorage.removeItem(LUATOOLS_ACCESS_KEY_STORAGE + '_key'); } catch(_) {}
                    try { localStorage.removeItem(LUATOOLS_ACCESS_KEY_STORAGE); } catch(_) {}
                    showAccessKeyModal(continueWithAdd);
                }
            })
            .catch(function() {
                // Server unreachable — fail safe: block and show error
                ShowLuaToolsAlert('i1Kosar & CONNOR', 'Could not reach the key server. Please check your connection.');
            });
        } else {
            // No key stored — show prompt
            showAccessKeyModal(continueWithAdd);
        }
    }
        ...
        if (anchor) {
            ...
            try {
                ...
                if (!isNaN(appid) && typeof Millennium !== 'undefined' && typeof Millennium.callServerMethod === 'function') {
                    ...
                    // Gate: require access key on first use
                    runAddFlowWithKeyGate(function () {
                ...
                Millennium.callServerMethod('luatools', 'GetAddViaLuaToolsStatus', {
                    ...
                    try {
                        ...
                        if (st.status === 'checking' && st.currentApi && title) {
                            title.textContent = lt('i1Kosar & CONNOR · {api}').replace('{api}', st.currentApi);
                        ...
                        if (st.status === 'done') {
                            ...
                            if (title) title.textContent = t('common.appName', 'i1Kosar & CONNOR');
    ...
    function showLoadedAppsPopup(apps) {
        ...
        title.textContent = lt('i1Kosar & CONNOR · Added Games');
        const body = document.createElement('div');
