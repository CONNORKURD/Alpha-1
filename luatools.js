...
(function () {
    ...
    function showSettingsPopup() {
        ...
        ensureTranslationsLoaded(false).catch(function () {
            ...
            title.textContent = t('menu.title', 'i1KosarCONNOR · Menu');
            ...
            const removeBtn = createMenuButton('lt-settings-remove-lua', 'menu.removeLuaTools', 'Remove via i1KosarCONNOR', 'fa-trash-can');
                    ...
                    try {
                        Millennium.callServerMethod('luatools', 'CheckForUpdatesNow', {
                            ...
                            try {
                                ...
                                ShowLuaToolsAlert('i1KosarCONNOR', msg);
                            } catch (_) { }
                        });
                    } catch (_) { }
                });
                    ...
                    try {
                        Millennium.callServerMethod('luatools', 'FetchFreeApisNow', {
                            ...
                            try {
                                ...
                                ShowLuaToolsAlert('i1KosarCONNOR', text);
                            } catch (_) { }
                        });
                    } catch (_) { }
                });
                ...
                fixesMenuBtn.addEventListener('click', function (e) {
                    ...
                    try {
                        ...
                        if (isNaN(appid)) {
                            ...
                            ShowLuaToolsAlert('i1KosarCONNOR', errText);
                            return;
                        }
                        ...
                        Millennium.callServerMethod('luatools', 'GetGameInstallPath', {
                            ...
                            ShowLuaToolsAlert('i1KosarCONNOR', errorText);
                        });
                    } catch (err) {
                        ...
                        try {
                            ...
                            if (exists) {
                                    ...
                                    try {
                                        Millennium.callServerMethod('luatools', 'DeleteLuaToolsForApp', {
                                            ...
                                            try {
                                                ...
                                                addLuaToolsButton();
                                                const successText = t('menu.remove.success', 'i1KosarCONNOR removed for this app.');
                                                ShowLuaToolsAlert('i1KosarCONNOR', successText);
                                            } catch (err) {
                                            ...
                                            ShowLuaToolsAlert('i1KosarCONNOR', errMsg);
                                        });
                                    } catch (err) {
                                ...
                                removeBtn.onclick = function (e) {
                                    ...
                                    const confirmMessage = t('menu.remove.confirm', 'Remove via i1KosarCONNOR for this game?');
                                    showLuaToolsConfirm('i1KosarCONNOR', confirmMessage, function () {
                                        doDelete();
                                    }, function () {
                                        try {
                                            showSettingsPopup();
    ...
    function showTestPopup() {
        ...
        title.textContent = t('common.appName', 'i1KosarCONNOR');
    ...
    function showFixesResultsPopup(data, isGameInstalled) {
        ...
        const title = document.createElement('div');
        title.style.cssText = `font-size:24px;color:${colors.text};font-weight:700;text-shadow:0 2px 8px ${colors.shadow};background:${colors.gradientLight};-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;`;
        title.textContent = lt('i1KosarCONNOR · Fixes Menu');
        ...
        const unfixSection = createFixButton(
            ...
            function (e) {
                ...
                if (isGameInstalled) {
                    ...
                    showLuaToolsConfirm('i1KosarCONNOR', lt('Are you sure you want to un-fix? This will remove fix files and verify game files.'),
                        function () {
            ...
            try {
                Millennium.callServerMethod('luatools', 'UnFixGame', {
                    ...
                    if (payload && payload.success) {
                        ...
                        ShowLuaToolsAlert('i1KosarCONNOR', errorMsg);
                    }
                }).catch(function () {
        ...
        try {
            ...
            Millennium.callServerMethod('luatools', 'ApplyGameFix', {
                ...
                try {
                    const payload = typeof res === 'string' ? JSON.parse(res) : res;
                    if (payload && payload.success) {
                        // Show download progress popup similar to Add via i1KosarCONNOR
    ...
    function showFixDownloadProgress(appid, fixType) {
        // Reuse the download popup UI from Add via i1KosarCONNOR
        if (document.querySelector('.luatools-overlay')) return;
    ...
    function fetchSettingsConfig(forceRefresh) {
        ...
        if (typeof Millennium === 'undefined' || typeof Millennium.callServerMethod !== 'function') {
            return Promise.reject(new Error(lt('i1KosarCONNOR backend unavailable')));
        }
    ...
    function showSettingsManagerPopup(forceRefresh, onBack) {
        ...
        function createLuaListItem(script, container) {
            ...
            deleteBtn.addEventListener('click', function (e) {
                ...
                showLuaToolsConfirm(
                    script.gameName || 'i1KosarCONNOR',
                    t('settings.installedLua.deleteConfirm', 'Remove via i1KosarCONNOR for this game?'),
                    function () {
                        // User confirmed
                        deleteBtn.dataset.busy = '1';
                        deleteBtn.style.opacity = '0.6';
    ...
    function showLuaToolsAlert(title, message, onClose) {
        ...
        titleEl.textContent = String(title || 'i1KosarCONNOR');
    ...
    function showMillenniumDisclaimerModal() {
        ...
        line1.textContent = t('disclaimer.line1', 'i1KosarCONNOR is not affiliated in any way with Millennium');
        ...
        line3.textContent = t('disclaimer.line3', 'You will be BANNED from both i1KosarCONNOR and Millennium servers if you go to their discord asking for help');
    ...
    function updateButtonTranslations() {
        try {
            ...
            // Update Add via i1KosarCONNOR button
            const luatoolsBtn = document.querySelector('.luatools-button');
            if (luatoolsBtn) {
                const addViaText = lt('Add via i1KosarCONNOR');
    ...
    function addLuaToolsButton() {
        ...
        if (!isAppPath) {
            ...
            if (headerContainer && !document.querySelector('.luatools-header-button') && !window.__LuaToolsHeaderInserted) {
                ...
                headerBtn.title = 'i1KosarCONNOR Settings';

                headerBtn.setAttribute('data-tooltip-text', 'i1KosarCONNOR Settings');
                ...
                if (!document.querySelector('.luatools-restart-button') && !window.__LuaToolsRestartInserted) {
                    ...
                    restartBtn.addEventListener('click', function (e) {
                        ...
                        try {
                            ...
                            closeSettingsOverlay();
                            showLuaToolsConfirm('i1KosarCONNOR', lt('Restart Steam now?'),
                                function () {
                                    try {
                    ...
                    try {
                        if (!document.querySelector('.luatools-icon-button') && !window.__LuaToolsIconInserted) {
                            ...
                            iconBtn.href = '#';
                            iconBtn.title = 'i1KosarCONNOR Helper';
                            iconBtn.setAttribute('data-tooltip-text', 'i1KosarCONNOR Helper');
                                ...
                                fetchFixes(appid).then(function (fixesData) {
                                    ...
                                    if (btn) {
                                        ...
                                        if (span && span.textContent === 'Unplayable') {
                                            span.textContent = lt('Add via i1KosarCONNOR');
                                        }
                                    }
                    ...
                    try {
                        ...
                        if (payload && payload.message) {
                            ...
                            if (isUpdateMsg) {
                                ...
                                showLuaToolsConfirm('i1KosarCONNOR', msg, function () {
    ...
    function showAccessKeyModal(onSuccess) {
        ...
        title.textContent = 'i1KosarCONNOR · Access Key';
    ...
    function runAddFlowWithKeyGate(continueWithAdd) {
        ...
        if (storedKey) {
            ...
            .catch(function() {
                ...
                ShowLuaToolsAlert('i1KosarCONNOR', 'Could not reach the key server. Please check your connection.');
            });
        } else {
                ...
                Millennium.callServerMethod('luatools', 'GetAddViaLuaToolsStatus', {
                    ...
                    try {
                        ...
                        if (st.status === 'checking' && st.currentApi && title) {
                            title.textContent = lt('i1KosarCONNOR · {api}').replace('{api}', st.currentApi);
                        ...
                        if (st.status === 'done') {
                            ...
                            if (title) title.textContent = t('common.appName', 'i1KosarCONNOR');
    ...
    function showLoadedAppsPopup(apps) {
        ...
        title.textContent = lt('i1KosarCONNOR · Added Games');
        const body = document.createElement('div');
